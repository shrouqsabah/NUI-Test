...
namespace TextComponentsTest
{
    class Example : NUIApplication
    {
        ...
        public void Initialize()
        {
            ...
            button.Clicked += (s, e) =>
            {
                if(redSpan.ForegroundColorDefined)
                {
            ...
            var builder = ForegroundColorSpanBuilder.Initialize();
            builder.WithForegroundColor(Color.Red);
            ...
            //Builder
            Spannable.AttachSpan(textTarget, ForegroundColorSpanBuilder
                                                .Initialize()
                                                .WithForegroundColor(Color.Green)
                                                .Build(),
                                            0,2);
            //Factory
            Spannable.AttachSpan(textTarget, ForegroundColorSpan.CreateWithForegroundColor(Color.Blue), 11,15);
